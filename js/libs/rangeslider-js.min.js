    ...
    return function (t) {
        ...
        t.exports = function (t, e) {
            var n = (e = e || e.currentTarget).getBoundingClientRect(),
                ...
                r = 0,
                o = 0;
            return t.touches && t.touches.length ? i(t.touches[0].pageX) && i(t.touches[0].pageY) ? (r = t.touches[0].pageX, o = t.touches[0].pageY) : i(t.touches[0].clientX) && i(t.touches[0].clientY) && (r = s.touches[0].clientX, o = s.touches[0].clientY) : i(t.pageX) && i(t.pageY) ? (r = t.pageX, o = t.pageY) : t.currentPoint && i(t.currentPoint.x) && i(t.currentPoint.y) && (r = t.currentPoint.x, o = t.currentPoint.y), {
                x: r - n.left,
                y: o - n.top
            }
        }
            ...
            l = {
                ...
                getFirstNumberLike: function () {
                    ...
                    for (var t = 0, e = arguments.length; t < e; t++)
                        if (n = arguments[t], a(parseFloat(n)) || a(n)) return arguments[t];
                    var n
                },
                getDimension: function (t, e) {
                    var n, i = function (t) {
                            for (var e = [], n = t.parentNode; n && r(n);) e.push(n), n = n.parentNode;
                            return e
                        }(t),
                        s = i.length,
                        o = [],
                    ...
                    if (s) {
                        for (u = 0; u < s; u++) n = i[u].style, o[u] = n.display, n.display = "block", n.height = "0", n.overflow = "hidden", n.visibility = "hidden", l(i[u]);
                        for (a = t[e], u = 0; u < s; u++) n = i[u].style, l(i[u]), n.display = o[u], n.height = "", n.overflow = "", n.visibility = ""
                    }
                    return a
                },
                ...
                forEachAncestorsAndSelf: function (t, e) {
                    for (e(t); t.parentNode && !e(t);) t = t.parentNode;
                    return t
                },
                ...
                return e = t, (n = [{
                    ...
                    value: function (t) {
                        if (t.preventDefault(), this.isInteracting = !0, this._listen(!0), !t.target.classList.contains(d.HANDLE_CLASS)) {
                            ...
                            this._setPosition(e - this.grabX), e >= i && e < i + this.handleWidth && (this.grabX = e - i), this._updatePercentFromValue()
                        }
                    }
                }, {
                    key: "_handleMove",
                    ...
                    value: function (t) {
                        ...
                        this.fill.style.width = n + this.grabX + "px", this.handle.style.webkitTransform = this.handle.style.transform = "translate(".concat(n, "px, -50%)"), this._setValue(e), this.position = n, this.value = e, this._updatePercentFromValue(), (this.isInteracting || this.needTriggerEvents) && (this.options.onSlideStart && 0 === this.onSlideEventsCount && this.options.onSlideStart.call(this, this.value, this.percent, this.position), this.options.onSlide && this.options.onSlide.call(this, this.value, this.percent, this.position)), this.onSlideEventsCount++
                    }
                }, {
                    ...
                    value: function () {
                        var t = this;
                        "undefined" != typeof window && window.removeEventListener("resize", this._update, !1), d.START_EVENTS.forEach(function (e) {
